<p align="center"><img src="img/B3887932883_l.jpg" alt="파이썬 라이브러리를 활용한 머신러닝" width="300"></p>
...
- **[08 마무리.md](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md)**
    - [01 머신러닝 문제 접근 방법](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#01-머신러닝-문제-접근-방법)
      - [1.1 의사 결정 참여](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#11-의사-결정-참여)
    - [02 프로토타입에서 제품까지](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#02-프로토타입에서-제품까지)
    - [03 제품 시스템 테스트](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#03-제품-시스템-테스트)
    - [04 나만의 추정기 만들기](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#04-나만의-추정기-만들기)
  - [변환기 만들기](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#변환기-만들기)
  - [회귀 모델: ClassifierMixin이나 RegressorMixin을 상속하고, transform 대신 predict 구현](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#회귀-모델-classifiermixin이나-regressormixin을-상속하고-transform-대신-predict-구현)
    - [05 더 배울 것들](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#05-더-배울-것들)
      - [5.1 이론](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#51-이론)
      - [5.2 다른 머신러닝 프레임워크와 패키지](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#52-다른-머신러닝-프레임워크와-패키지)
      - [5.3 랭킹, 추천 시스템과 그 외 다른 알고리즘](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#53-랭킹-추천-시스템과-그-외-다른-알고리즘)
      - [5.4 확률적 모델링, 추론, 확률적 프로그래밍](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#54-확률적-모델링-추론-확률적-프로그래밍)
      - [5.5 신경망](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#55-신경망)
      - [5.6 대규모 데이터셋으로 확장](https://github.com/tjdux/Introduction-to-Machine-Learning-with-Python/blob/main/08%20%EB%A7%88%EB%AC%B4%EB%A6%AC.md#56-대규모-데이터셋으로-확장)
